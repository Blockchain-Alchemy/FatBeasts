...
import sty from "./PlasmicFaq.module.css"; // plasmic-import: vCrA6_psD6Ory/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox___6GsBu)}
      >
        <div className={classNames(projectcss.all, sty.freeBox___8I7Ez)}>
          <div className={classNames(projectcss.all, sty.freeBox__dA1V)}>
            {p.renderPlasmicSlot({
