...
import Avatar from "../../Avatar"; // plasmic-import: 3ij4T5NC7K_BN7/component
...
import sty from "./PlasmicTestimonial.module.css"; // plasmic-import: kgwl9AdjE1pjcY/css

import QuoteDashesIcon from "./icons/PlasmicIcon__QuoteDashes"; // plasmic-import: nq_ltjNligTFR3/icon
import profilepicG3He8EdGkOw9Pv from "./images/profilepic.png"; // plasmic-import: g3he8edGkOw9pv/picture
  ...
  return (
    ...
    >
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox___69N8K)}
      >
        <div
          className={classNames(
            projectcss.all,
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__vTuKa)}
        >
          <div
            className={classNames(
              projectcss.all,
