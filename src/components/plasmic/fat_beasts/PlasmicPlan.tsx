...
import BaseCard from "../../BaseCard"; // plasmic-import: RL2n4iHAK-VBA/component
...
import sty from "./PlasmicPlan.module.css"; // plasmic-import: kzng3vFlBnMD7/css
...
function PlasmicPlan__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__xIVkp)}>
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__rm2Mh)}
        >
          {p.renderPlasmicSlot({
          ...
          {p.renderPlasmicSlot({
            defaultContents: (
              <p.Stack
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox__eCDge)}
              >
                <Bullet
                  className={classNames("__wab_instance", sty.bullet__uxTja)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__rNzRu)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet___8ZWq)}
                />
              </p.Stack>
            ),
          ...
          <div className={classNames(projectcss.all, sty.freeBox___1GPr)}>
            {p.renderPlasmicSlot({
              defaultContents: (
                <Button
                  className={classNames("__wab_instance", sty.button__bheHd)}
